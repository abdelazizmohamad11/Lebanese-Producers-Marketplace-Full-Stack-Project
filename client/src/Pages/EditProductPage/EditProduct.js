...
const EditProduct = () => {
    ...
    useEffect(
        () => {
            ...
            if(product){
                ...
                setEnteredCategory(product.category)
            }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`http://localhost:8000/products/edit-product/${product_id}`, {
                name: enteredName,
    ...
    const handleDeleteImage = async () => {
        try {
            const response = await axios.post(`http://localhost:8000/images/delete-product-image/${product_id}`);
                ...
                <form className={styles.form} id='form' onSubmit={handleSubmit}>
                    <div className={styles['control-input']}>
                        ...
                        <div>
                            ...
                            {product.image && !imageDeleted && <Button type='button' onClick={handleDeleteImage}>Delete Image</Button>}
                        </div>
                    </div>
